...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const factor = 0.5; // shift focus upward
...
<div align="center">
  <img src="./assets/zafira_logo.jpg" alt="Project Cover" width="35%" style="border-radius:10px; display: block;"/>
  
  <em style="margin-top: 40px;">This project was born from the desire to  provide Zafira Solidaire a website to act as both a showcase and a technical hub.</em>
